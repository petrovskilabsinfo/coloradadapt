...
function App() {
  ...
  const safeT = {
    ...t,
    musicAdapt: t.musicAdapt || tEn.musicAdapt,
    petrovskiStudio: t.petrovskiStudio || tEn.petrovskiStudio
  };
  ...
  return (
    <div className={`min-h-screen ${themeClasses.background} ${themeClasses.text} relative overflow-hidden transition-all duration-700`}>
      ...
      <nav className={`fixed top-0 w-full ${themeClasses.navBg} backdrop-blur-xl border-b ${themeClasses.navBorder} z-40 transition-all duration-700 ${currentLanguage === 'ar' ? 'rtl' : 'ltr'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            <div className="font-bold text-xl sm:text-2xl bg-gradient-to-r from-purple-600 to-cyan-500 bg-clip-text text-transparent truncate">
              {t.nav.brand}
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4 md:space-x-6">
              ...
              <button 
                ...
                className={`${themeClasses.textSecondary} hover:text-purple-500 transition-all duration-300 font-medium relative group text-sm sm:text-base hidden sm:block`}
              >
                {t.nav.privacy}
      ...
      {/* Hero Section */}
      <section className={`min-h-screen flex items-center justify-center px-4 sm:px-6 pt-20 sm:pt-24 relative z-10 ${currentLanguage === 'ar' ? 'rtl' : 'ltr'}`}>
        <div className={`max-w-6xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold ${themeClasses.text} mb-6 sm:mb-8 leading-tight px-4`}>
            {t.hero.title}{' '}
          ...
          <p className={`text-lg sm:text-xl md:text-2xl lg:text-3xl ${themeClasses.textSecondary} mb-4 sm:mb-6 font-light px-4`}>
            {t.hero.subtitle}
          </p>
          
          <p className={`text-base sm:text-lg mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed px-4`}>
            {t.hero.description}
          </p>
      ...
      {/* Features Section */}
      <section id="features" className={`py-16 sm:py-24 md:py-32 px-4 sm:px-6 relative z-10 ${currentLanguage === 'ar' ? 'rtl' : 'ltr'}`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className={`text-base sm:text-lg md:text-xl ${themeClasses.textSecondary} max-w-4xl mx-auto leading-relaxed px-4`}>
              {t.features.subtitle}
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              <div key={index} className={`group relative p-6 sm:p-8 rounded-3xl ${themeClasses.cardBg} border ${themeClasses.cardBorder} backdrop-blur-sm ${themeClasses.cardHover} transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-purple-500/10`}>
      ...
      <section className={`py-32 px-6 relative z-10 ${currentLanguage === 'ar' ? 'rtl' : 'ltr'}`}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className={`relative p-12 rounded-3xl ${isDarkTheme ? 'bg-gradient-to-br from-slate-800/50 to-slate-900/50 border-purple-500/30' : 'bg-gradient-to-br from-white/80 to-purple-50/80 border-purple-300/40'} border backdrop-blur-sm`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                  {['Chrome', 'Edge', 'Safari', 'Opera', 'Firefox', 'Brave', 'Vivaldi', 'Yandex Browser'].map((platform, index) => (
                  <span key={index} className={`px-4 sm:px-6 py-2 sm:py-3 rounded-full font-medium border transition-all duration-300 hover:scale-105 text-sm sm:text-base ${
                    ...
                    index === 3 ? `${isDarkTheme ? 'bg-green-500/20 text-green-300 border-green-500/30 hover:bg-green-500/30' : 'bg-green-100/80 text-green-700 border-green-300/50 hover:bg-green-200/80'}` :
                    index === 4 ? `${isDarkTheme ? 'bg-orange-500/20 text-orange-300 border-orange-500/30 hover:bg-orange-500/30' : 'bg-orange-100/80 text-orange-700 border-orange-300/50 hover:bg-orange-200/80'}` :
                    index === 5 ? `${isDarkTheme ? 'bg-yellow-500/20 text-yellow-300 border-yellow-500/30 hover:bg-yellow-500/30' : 'bg-yellow-100/80 text-yellow-700 border-yellow-300/50 hover:bg-yellow-200/80'}` :
                    `${isDarkTheme ? 'bg-red-500/20 text-red-300 border-red-500/30 hover:bg-red-500/30' : 'bg-red-100/80 text-red-700 border-red-300/50 hover:bg-red-200/80'}`
                  }`}>
                    {platform}
                  </span>
                ))}
          ...
          {/* MusicAdapt Promotion Section - Compact */}
          <div className={`relative mt-8 p-6 sm:p-8 md:p-10 rounded-3xl ${isDarkTheme ? 'bg-gradient-to-br from-slate-800/50 to-slate-900/50 border-purple-500/30' : 'bg-gradient-to-br from-white/80 to-purple-50/80 border-purple-300/40'} border backdrop-blur-sm group hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500`}>
            ...
            <div className="relative z-10 text-center px-4">
              <h2 className={`text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r ${isDarkTheme ? 'from-purple-400 to-cyan-400' : 'from-purple-600 to-cyan-600'} bg-clip-text text-transparent mb-3 sm:mb-4`}>
                {safeT.musicAdapt.title}
              </h2>
              <p className={`text-base sm:text-lg md:text-xl ${themeClasses.textSecondary} mb-4 sm:mb-6 max-w-2xl mx-auto leading-relaxed`}>
                {safeT.musicAdapt.subtitle}
              </p>
              <a 
      ...
      <section id="privacy" className={`py-16 sm:py-24 md:py-32 px-4 sm:px-6 relative z-10 ${currentLanguage === 'ar' ? 'rtl' : 'ltr'}`}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className={`relative p-8 sm:p-10 md:p-12 rounded-3xl ${isDarkTheme ? 'bg-gradient-to-br from-slate-800/50 to-slate-900/50 border-purple-500/30' : 'bg-gradient-to-br from-white/80 to-purple-50/80 border-purple-300/40'} border backdrop-blur-sm group hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500`}>
            <div className={`absolute inset-0 rounded-3xl ${isDarkTheme ? 'bg-gradient-to-br from-purple-500/10 to-cyan-500/10' : 'bg-gradient-to-br from-purple-100/60 to-cyan-100/60'} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
            <div className="relative z-10 text-center px-4">
              <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r ${isDarkTheme ? 'from-purple-400 to-cyan-400' : 'from-purple-600 to-cyan-600'} bg-clip-text text-transparent mb-4 sm:mb-6`}>
                {safeT.petrovskiStudio.title}
              </h2>
              <p className={`text-base sm:text-lg md:text-xl ${themeClasses.textSecondary} mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed`}>
               {safeT.petrovskiStudio.subtitle}
              </p>
              <a 
